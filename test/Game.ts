...
describe('Game', function () {
	...
	describe('Dugeon Management', function () {
		it('should add a new dungeon', async function () {
			...
			// approve:
			await game.addDungeon(name, startIn, endIn, minMintFee, minTermDate, maxTermDate, failurePercentage, rewardToken)
	...
	describe('Game Play', function () {
		it('should start a new session', async function () {
			...
			// approve:
			await rewardToken.approve(game.target, rewardAmount)
			await game.addDungeon(name, startIn, endIn, minMintFee, minTermDate, maxTermDate, failurePercentage, rewardAmount)
