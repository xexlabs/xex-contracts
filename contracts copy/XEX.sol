...
contract XEX is ERC20Upgradeable, OwnableUpgradeable {
    ...
    uint256 public constant MAX_TERM_START = 10 * SECONDS_IN_DAY; // 100 * SECONDS_IN_DAY;
    uint256 public constant MAX_TERM_END = 10 * SECONDS_IN_DAY; // 244 * SECONDS_IN_DAY;
    uint256 public constant TERM_AMPLIFIER = 1; // 15;
    uint256 public constant TERM_AMPLIFIER_THRESHOLD = 1; //5_000;
    uint256 public constant REWARD_AMPLIFIER_START = 1; //701;
    uint256 public constant REWARD_AMPLIFIER_END = 1; //1;
    uint256 public constant EAA_PM_START = 1; //1_000;
    uint256 public constant EAA_PM_STEP = 1; //10;
    uint256 public constant EAA_RANK_STEP = 1; //10_000;
    uint256 public constant WITHDRAWAL_WINDOW_DAYS = 7;
    uint256 public constant MAX_PENALTY_PCT = 90; // 99;
    uint256 public constant XEX_MIN_STAKE = 0;
    uint256 public constant XEX_MIN_BURN = 0;
    uint256 public constant XEX_APY_START = 20; // 50;
    //REVIEW: XEX_APY_DAYS_STEP can't be 0, setting to 1.
    uint256 public constant XEX_APY_DAYS_STEP = 1; // 14;
    uint256 public constant XEX_APY_END = 20; // 0;
    string public constant AUTHORS_XEN = "@MrJackLevin @lbelyaev faircrypto.org t.me/bitdeep";
     ...
     */
    function _calculateStakeReward(uint256 amount, uint256 term, uint256 maturityTs, uint256 apy) private view returns (uint256) {
